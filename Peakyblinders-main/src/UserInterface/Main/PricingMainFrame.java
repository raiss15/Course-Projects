...
public class PricingMainFrame extends javax.swing.JFrame {
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
        ...
        BusinessManagerWorkAreaJPanel businessManagerWorkArea;
...
//            ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
            ...
            SalesPersonWorkAreaJPanel panel = new SalesPersonWorkAreaJPanel(CardSequencePanel, business, spp);
            CardSequencePanel.add("sales", panel);
...
//            ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
            ...
            MarketingManagerWorkAreaJPanel1 panel = new MarketingManagerWorkAreaJPanel1(CardSequencePanel, business, mpp);
            CardSequencePanel.add("Marketing", panel);
            CardLayout layout = (CardLayout) CardSequencePanel.getLayout();
            layout.next(CardSequencePanel);
...
//            ((java.awt.CardLayout) CardSequencePanel.getLayout()).next(CardSequencePanel);
            ...
            BusinessManagerWorkAreaJPanel panel = new BusinessManagerWorkAreaJPanel(CardSequencePanel, business, ep);
            CardSequencePanel.add("Admin", panel);
            CardLayout layout = (CardLayout) CardSequencePanel.getLayout();
            layout.next(CardSequencePanel);
