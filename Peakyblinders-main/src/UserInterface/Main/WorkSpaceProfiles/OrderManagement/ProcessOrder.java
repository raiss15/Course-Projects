...
public class ProcessOrder extends javax.swing.JPanel {
    ...
    public ProcessOrder(JPanel workArea, Business business, CustomerProfile selectedCustomer, SalesPersonProfile salesPerson) {
        ...
        customerTextField.setText(selectedCustomer.getCustomerId());
        MasterOrderList mol = business.getMasterOrderList();
        currentOrder =  mol.newOrder(selectedCustomer, salesPerson); //no order was made yet
        initializeTable();
